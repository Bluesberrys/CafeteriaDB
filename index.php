...
<html lang="en">
  ...
  <body>
    ...
    <main>
      ...
      <div
        id="myCarousel"
        class="carousel slide mb-6 border-bottom border-black"
      ...
      >
        ...
        <div class="carousel-inner">
          ...
          <div class="carousel-item">
            <img
              src="./img/home/RedVelvetSlice.jpg"
              class="d-block"
              height="100%"
              width="100%"
              alt="Latte"
    ...
    <div class="footer border-top border-black">
      <footer class="pt-5">
        ...
        <div
          class="d-flex flex-column flex-sm-row justify-content-between pt-4 mt-4 border-top border-black"
        >
